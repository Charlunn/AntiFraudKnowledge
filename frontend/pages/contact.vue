    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
      <div class="bg-white rounded-lg shadow-sm p-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <!-- 联系表单 -->
          <div>
            <h2 class="text-xl font-semibold text-gray-800 mb-4">发送消息</h2>
          ...
          <!-- 联系信息 -->
          <div>
            <h2 class="text-xl font-semibold text-gray-800 mb-4">联系信息</h2>
            <div class="space-y-4">
              <div class="flex items-start space-x-3">
                <div class="w-5 h-5 text-blue-600 mt-1">
                ...
                <div>
                  <h3 class="font-medium text-gray-900">邮箱</h3>
                  <p class="text-gray-600">support@antifraud.com</p>
                </div>
              </div>
              ...
              <div class="flex items-start space-x-3">
                ...
                <div>
                  <h3 class="font-medium text-gray-900">地址</h3>
              ...
              <div class="flex items-start space-x-3">
                ...
                <div>
                  <h3 class="font-medium text-gray-900">电话</h3>
            ...
            <div class="mt-8">
              <h3 class="font-medium text-gray-900 mb-2">工作时间</h3>
              <p class="text-gray-600">周一至周五：9:00 - 18:00</p>
              <p class="text-gray-600">周末：10:00 - 16:00</p>
            </div>
          </div>
        </div>
      </div>
