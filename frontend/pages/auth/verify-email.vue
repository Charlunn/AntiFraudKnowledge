    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <div v-if="verificationStatus === 'loading'" class="text-center">
          ...
          <p class="mt-4 text-gray-600">正在验证您的邮箱...</p>
        </div>
        ...
        <div v-else-if="verificationStatus === 'success'" class="text-center">
          ...
          <h3 class="mt-4 text-lg font-medium text-gray-900">邮箱验证成功！</h3>
          <p class="mt-2 text-sm text-gray-600">
        ...
        <div v-else-if="verificationStatus === 'error'" class="text-center">
          ...
          <h3 class="mt-4 text-lg font-medium text-gray-900">验证失败</h3>
          <p class="mt-2 text-sm text-gray-600">
        ...
        <div v-else class="text-center">
          ...
          <h3 class="mt-4 text-lg font-medium text-gray-900">验证邮件已发送</h3>
          <p class="mt-2 text-sm text-gray-600">
